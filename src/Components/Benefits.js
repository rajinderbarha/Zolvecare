    ...
    return (
        <div className='Benefits'>
            <div className='container_Benefits'>
                <h2 className='md:mb-16 text-center font-semibold  mb-10 mx-auto '>We make simplifying healthcare documentation</h2>
                <div className='Benefits_health'>
                    <div className='grid items-center md:gap-16 gap-6 md:grid-cols-2 grid-cols-1'>
                        ...
                        <div className='Efficiency_img'>
                            <Image
                                className=" w-full"
                                src="/Image/Features/Efficiency.png"
                                alt="logos"
                                width={468}
                                height={384}
                            />
                    ...
                    <div className='grid items-center  md:gap-16 gap-6 md:grid-cols-2 grid-cols-1'>
                        ...
                        <div className='Efficiency_img'>
                            <Image
                                className=" w-full"
                                src="/Image/Features/optimized.png"
                                alt="logos"
                                width={468}
                                height={384}
                            />
